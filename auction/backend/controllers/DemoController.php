...
<meta http-equiv="content-type" content="text/html; charset=UTF-8"><meta charset="utf-8">
            ...
            username:<input name="username" value="luxin">               <br>
            password:<input name="password" value="e10adc3949ba59abbe56e057f20f883e" type="password">     <br>
            ...
            <b>10,图处上传接口</b>
            <form action="index.php?r=port/index" method="post"  enctype="MULTIPART/FORM-DATA">
                <br>员工ID:<input name="emp_id" value="1">
                <br>令牌:<input size="150" name="token" value="VTVIAuqhrMRi82bMxQEwo2I1NTMzZWUyNTllNDAxY2RjMzFhMjQ2MmU3Yjg4ZmY0MDQwOTBhYjVkNTQ1N2Q1OTM5YjBhNzBlNjUwMWFhZjN2H0HNasdRYDhnXjDWZS6lizCHoIhzpE0DeQBak6Q6BfyNttKB/jI+deuh59wEcX6400xwR8J8eTkH64ZWX3nF">
